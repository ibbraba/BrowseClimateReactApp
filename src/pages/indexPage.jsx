  ...
  return (
    <div>
      ...
      <div className='home-rubrique-container'>
        ...
        <h3> Les plus belles villes du monde sont la  </h3>
        ...
        <Link className='btn btn-primary' to="/city"> Decouvrir les villes </Link>


      </div>

      <div className="home-rubrique-container">
        <h3> Nos plus belles écritures </h3>
        ...
        <Link className='btn btn-primary' to="/article"> Lire les articles </Link>
      </div>
      ...
      <div className="home-rubrique-container">
        ...
        <h3> Votre profil, votre monde </h3>
